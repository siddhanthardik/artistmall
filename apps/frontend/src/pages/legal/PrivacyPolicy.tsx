          ...
          <div className="bg-white border border-slate-200 rounded-[40px] p-10 md:p-20 shadow-sm space-y-16">
            <div className="prose prose-slate max-w-none">
              ...
              <p className="text-slate-600 font-medium leading-relaxed">
                At The Artist Mall, we understand that privacy matters for artists, clients, and
                event teams. This Privacy Policy outlines how we collect, protect, and use your
                information within our booking platform.
              </p>
            </div>
            ...
            <div className="bg-slate-50 rounded-3xl p-10 border border-slate-100">
              ...
              <p className="text-slate-500 text-sm font-medium leading-relaxed mb-6">
                You maintain full control over your professional data. Artists can request data
                portability or account closure at any time through our legal desk.
              </p>
