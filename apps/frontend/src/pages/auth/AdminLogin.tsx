  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col justify-between relative overflow-hidden font-sans">
        ...
        >
          ...
          <div className="bg-white border border-[#fdf0e9] rounded-[48px] p-12 md:p-16 shadow-2xl shadow-brand-primary/5">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-3xl font-bold text-neutral-content tracking-tight mb-2">
                Admin Portal
              </h1>
              <p className="text-neutral-content/40 text-sm font-medium">
                Please enter your credentials to manage the mall.
              </p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-8">
              ...
              <div className="space-y-3">
                <label className="block text-[10px] font-black text-neutral-content/60 uppercase tracking-[0.2em] ml-1">
                  EMAIL ADDRESS
                </label>
                <input
                  type="email"
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center px-1">
                  <label className="block text-[10px] font-black text-neutral-content/60 uppercase tracking-[0.2em]">
                    PASSWORD
                  </label>
                  <button
                    type="button"
                    className="text-[10px] font-black text-brand-secondary hover:underline tracking-tight"
                  >
                    Forgot Password?
                  </button>
                </div>
            ...
            <div className="mt-12 space-y-6">
              ...
              <p className="text-center">
                ...
                <button className="text-xs font-black text-brand-secondary hover:underline">
                  Contact Support
                </button>
              </p>
            </div>
      ...
      <footer className="w-full px-10 py-12 border-t border-surface-container flex flex-col md:flex-row justify-between items-center gap-8">
        <p className="text-lg font-bold text-neutral-content tracking-tighter">
          Artist Mall <span className="text-brand-primary">Vibrant</span>
        </p>

        <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
          <button className="text-xs font-bold text-neutral-content/60 hover:text-neutral-content transition-colors">
            Terms of Service
          </button>
          <button className="text-xs font-bold text-neutral-content/60 hover:text-neutral-content transition-colors">
            Privacy Policy
        ...
        <p className="text-xs font-bold text-neutral-content/30">
          © 2024 Artist Mall Vibrant. All rights reserved.
        </p>
      </footer>
    </div>
  );
