        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-neutral-content/60 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
              Whether you're planning a gala or a private exhibition, we help you find the perfect artist to transform your vision into an unforgettable reality.
            </p>
          </motion.div>
          <motion.div
      ...
      <section className="py-24 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            >
              <h2 className="text-3xl font-bold text-neutral-content tracking-tight mb-10">Send a Message</h2>
              <form className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-neutral-content/40 uppercase tracking-[0.2em] ml-1">EVENT TYPE</label>
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-neutral-content/40 uppercase tracking-[0.2em] ml-1">MESSAGE</label>
                  <textarea 
                    rows={4}
            ...
            <div className="lg:col-span-5 space-y-12">
              <div className="space-y-10">
                <h3 className="text-2xl font-bold text-neutral-content tracking-tight">Contact Details</h3>
              ...
              >
                <div className="relative h-64 bg-[#e5e7eb] flex items-center justify-center overflow-hidden">
                  ...
                  <div className="absolute flex flex-col items-center">
                    ...
                    <p className="text-white font-bold text-lg tracking-tight">Visit Us in New Delhi</p>
          ...
          >
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-white/60 text-xl font-medium max-w-2xl mx-auto leading-relaxed">
                Our curators are standing by to help you select the perfect artistic talent for your specific needs.
              </p>
            </div>
...
const FormInput = ({ label, placeholder, type = "text" }: any) => (
  <div className="space-y-3">
    <label className="text-[10px] font-black text-neutral-content/40 uppercase tracking-[0.2em] ml-1">{label}</label>
    <input 
      type={type} 
...
const DetailItem = ({ icon: Icon, title, value, iconBg, isLink, link }: any) => (
  <div className="flex items-start gap-6">
    <div className={`w-12 h-12 ${iconBg} rounded-2xl flex items-center justify-center text-white shrink-0`}>
      <Icon className="w-5 h-5" />
    </div>
    <div className="space-y-1">
      <p className="text-sm font-bold text-neutral-content tracking-tight">{title}</p>
      {isLink ? (
        <a href={link} className="text-brand-secondary font-bold text-sm hover:underline">{value}</a>
      ) : (
        <p className="text-neutral-content/40 font-medium text-sm leading-relaxed max-w-[200px]">{value}</p>
      )}
    </div>
  </div>
);
