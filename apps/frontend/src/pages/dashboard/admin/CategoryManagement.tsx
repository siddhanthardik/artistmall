    ...
    <div className="space-y-10">
      <div className="flex items-end justify-between">
        ...
        <Button
          ...
          className="bg-brand-orange hover:bg-brand-orangeHover text-white font-bold px-8 py-3.5 rounded-xl shadow-lg shadow-brand-orange/20 flex items-center gap-2 transition-all"
        >
          ...
          {isLoading ? (
            ...
            <div className="divide-y divide-slate-100">
              {categories.map((category: any) => (
                <div
                  key={category._id}
                  className="p-6 hover:bg-slate-50 transition-all group flex items-center justify-between"
                >
                  <div className="flex items-center gap-6">
                  ...
                  <div className="flex items-center gap-3 opacity-0 group-hover:opacity-100 transition-all transform translate-x-4 group-hover:translate-x-0">
                    ...
                    <button
                      onClick={() => {
                        if (confirm('Delete category?')) deleteMutation.mutate(category._id);
                      }}
                ...
                <div className="p-8 space-y-6 max-h-[70vh] overflow-y-auto">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <span className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 font-mono text-sm">
                        /
                      </span>
                      <input
                        type="text"
