      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[10px] font-black text-neutral-content/40 uppercase tracking-[0.3em] mt-1">
            Homepage Visual Inventory Management
          </p>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-surface-container">
                <th className="px-8 py-6 text-[10px] font-black text-neutral-content/40 uppercase tracking-widest w-24">
                  Order
                </th>
                ...
                <th className="px-6 py-6 text-[10px] font-black text-neutral-content/40 uppercase tracking-widest text-center">
                  Status
                </th>
                <th className="px-8 py-6 text-[10px] font-black text-neutral-content/40 uppercase tracking-widest text-right">
                  Actions
                </th>
              </tr>
            </thead>
                  ...
                  >
                    ...
                    <td className="px-6 py-6">
                      <div className="space-y-1">
                        <p className="text-sm font-black text-neutral-content uppercase tracking-tight">
                          {banner.title || 'Untitled Banner'}
                        </p>
                        <p className="text-[10px] font-bold text-neutral-content/40 truncate max-w-[250px]">
                        ...
                        {banner.ctaText && (
                          <div className="inline-flex items-center gap-2 mt-2 px-2 py-0.5 bg-brand-primary/10 rounded-full">
                            <span className="text-[8px] font-black text-brand-primary uppercase tracking-tighter">
                              CTA: {banner.ctaText}
                            </span>
                          </div>
                        )}
