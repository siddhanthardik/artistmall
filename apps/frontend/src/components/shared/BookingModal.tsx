              ...
              <div className="flex flex-col h-[85vh] md:h-auto max-h-[90vh]">
                ...
                <div className="p-8 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                  <div>
                    ...
                    <p className="text-brand-orange font-bold text-[10px] uppercase tracking-[0.2em] mt-1">
                      Artist Booking Inquiry
                    </p>
                  </div>
                  <button
                    onClick={handleClose}
                    className="p-3 bg-white hover:bg-slate-100 rounded-full text-slate-400 hover:text-slate-900 transition-all shadow-sm border border-slate-200"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>
                ...
                >
                  ...
                  <div className="p-6 bg-slate-900 rounded-3xl text-white space-y-4 shadow-xl shadow-slate-900/10">
                    ...
                    <p className="text-xs font-medium text-slate-300 leading-relaxed">
                      Your inquiry will be reviewed by our booking team. We will contact you to
                      confirm requirements, availability, and next steps.
                    </p>
                  </div>
                </form>
              ...
              <div className="p-16 text-center space-y-8">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-semibold max-w-sm mx-auto text-lg">
                    ...
                    <span className="text-brand-orange">30 minutes</span>.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-4 mt-8">
                  ...
                  >
                    Need urgent response? Chat on WhatsApp{' '}
