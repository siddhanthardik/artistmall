          ...
          <div className="bg-white border border-slate-200 rounded-[40px] p-10 md:p-20 shadow-sm space-y-16">
            <div className="prose prose-slate max-w-none">
              ...
              <p className="text-slate-600 font-medium leading-relaxed">
                The Artist Mall provides a secure platform and support service for professional
                artist booking. While we maintain verification processes, users should acknowledge
                the following legal boundaries of the platform's responsibility.
              </p>
            </div>
            ...
            <div className="bg-slate-50 rounded-3xl p-10 border border-slate-100">
              ...
              <p className="text-slate-500 text-sm font-medium leading-relaxed mb-6">
                Information provided on The Artist Mall regarding event coordination and artist
                management is for general reference only and does not constitute legal or
                professional event-planning advice.
              </p>
          ...
          <div className="bg-white border border-slate-200 rounded-[40px] p-10 md:p-20 shadow-sm space-y-12">
            <div className="prose prose-slate max-w-none">
              <p className="text-slate-600 font-medium leading-relaxed text-lg">
                The Artist Mall uses cookies to improve your browsing experience and facilitate
                secure talent bookings. By continuing to use our platform, you agree to our use of
                essential and analytical cookies.
              </p>
            </div>
            <LegalSection
