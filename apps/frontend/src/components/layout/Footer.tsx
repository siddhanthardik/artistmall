    ...
    <footer className="bg-surface-lowest pt-24 pb-12 border-t border-surface-container">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 mb-20">
          ...
          <div className="lg:col-span-4">
            <Link to="/" className="block mb-8">
              <img src="/logo.png" alt="The Artist Mall" className="h-12 w-auto" />
            </Link>
            <p className="text-neutral-content/60 text-base font-medium leading-relaxed mb-8 max-w-sm">
              A verified artist directory and booking support platform for corporate events,
              weddings, private functions, and live shows.
            </p>
            <div className="flex items-center gap-4">
              <a
                ...
                className="w-10 h-10 bg-surface-low text-neutral-content/40 rounded-full flex items-center justify-center hover:bg-brand-primary hover:text-white transition-all shadow-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-surface-low text-neutral-content/40 rounded-full flex items-center justify-center hover:bg-brand-secondary hover:text-white transition-all shadow-sm"
              >
          ...
          <div className="lg:col-span-2">
            <h4 className="text-neutral-content text-xs font-black uppercase tracking-[0.2em] mb-8">
              Navigation
            </h4>
            <ul className="space-y-4">
              <li>
                <Link
                  to="/about"
                  className="text-neutral-content/60 hover:text-brand-primary font-bold text-sm transition-colors"
                >
                  About Us
                </Link>
              </li>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-content/60 text-sm mt-1 whitespace-pre-line">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-neutral-content/60 text-sm mt-1 hover:text-brand-secondary transition-colors block"
                  >
                    {CONTACT_INFO.EMAIL}
                  </a>
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-neutral-content/60 text-sm mt-1 hover:text-brand-success transition-colors block"
                  >
        ...
        <div className="border-t border-surface-container pt-12 pb-8 flex flex-wrap gap-x-8 gap-y-4">
          <Link
            to="/privacy-policy"
            className="text-neutral-content/40 hover:text-neutral-content text-[11px] font-bold uppercase tracking-widest transition-colors"
          >
            Privacy Policy
          </Link>
          <Link
