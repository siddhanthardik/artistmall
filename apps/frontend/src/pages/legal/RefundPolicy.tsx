          ...
          <div className="bg-white border border-slate-200 rounded-[40px] p-10 md:p-20 shadow-sm space-y-16">
            <div className="prose prose-slate max-w-none">
              ...
              <p className="text-slate-600 font-medium leading-relaxed">
                The Artist Mall operates with an escrow-first model to ensure that every booking is
                financially protected. Our refund policy is designed to be fair, transparent, and
                legally sound for both the host and the talent.
              </p>
            </div>
            ...
            <div className="bg-green-50 rounded-3xl p-10 border border-green-100">
              ...
              <p className="text-slate-600 text-sm font-medium leading-relaxed mb-6">
                Your event budget is held in a secure escrow account. Funds are only transferred to
                the artist after our operations team confirms successful performance delivery.
              </p>
