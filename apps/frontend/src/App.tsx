      ...
      <BrowserRouter>
        <div className="flex flex-col min-h-screen">
          <Routes>
            ...
            <Route path="/artists" element={<Public><Discovery /></Public>} />
            <Route path="/artists/:id" element={<Public><ArtistDetail /></Public>} />
            ...
            <Route path="/corporate-solutions" element={<Public><CorporateSolutions /></Public>} />
            <Route path="/testimonials" element={<Public><Testimonials /></Public>} />
            <Route path="/faq" element={<Public><FAQ /></Public>} />
            <Route path="/why-choose-us" element={<Public><WhyChooseUs /></Public>} />
            <Route path="/wedding-entertainment" element={<Public><WeddingEntertainment /></Public>} />
            <Route path="/celebrity-booking" element={<Public><CelebrityBooking /></Public>} />
            <Route path="/artist-categories" element={<Public><CategoriesLanding /></Public>} />
            <Route path="/featured-artists" element={<Public><FeaturedArtistsLanding /></Public>} />

            {/* ── Legal & Compliance Pages ──────────────────────────── */}
            <Route path="/privacy-policy" element={<Public><PrivacyPolicy /></Public>} />
            <Route path="/terms" element={<Public><Terms /></Public>} />
            <Route path="/refund-policy" element={<Public><RefundPolicy /></Public>} />
            <Route path="/booking-policy" element={<Public><BookingPolicy /></Public>} />
            <Route path="/cancellation-policy" element={<Public><BookingPolicy /></Public>} />
            <Route path="/kyc-policy" element={<Public><KycPolicy /></Public>} />
            <Route path="/artist-agreement" element={<Public><ArtistAgreement /></Public>} />
            <Route path="/cookie-policy" element={<Public><CookiePolicy /></Public>} />
            <Route path="/disclaimer" element={<Public><Disclaimer /></Public>} />

            {/* ── Auth (No Navbar/Footer) ───────────────────────────── */}
            <Route path="/admin/login" element={<AdminLogin />} />

            {/* ── Secure Internal Operations ────────────────────────── */}
            <Route path="/admin" element={<ProtectedRoute allowedRoles={['SUPER_ADMIN', 'SUB_ADMIN', 'INTERNAL_OPS', 'FINANCE']}><AdminLayout /></ProtectedRoute>}>
