    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <section className="relative pt-40 pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          >
            ...
            <span className="text-slate-500 text-[10px] font-black uppercase tracking-[0.5em]">Why Choose Us</span>
          </motion.div>
          ...
          <p className="text-slate-500 text-xl md:text-2xl font-medium tracking-tight max-w-2xl leading-relaxed">
            The Artist Mall gives event teams a clearer way to review artist profiles, send booking inquiries, and coordinate requirements.
          </p>
        </div>
      </section>
          ...
          <div className="bg-white border border-slate-200 rounded-[48px] overflow-hidden shadow-2xl">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-16 border-b lg:border-b-0 lg:border-r border-slate-100 bg-slate-50/50">
                <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.3em] mb-12">Traditional Booking</h3>
              ...
              <div className="p-16 bg-white relative">
                <div className="absolute top-0 right-0 p-8">
                   <div className="bg-orange-50 text-brand-orange px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest border border-orange-100 shadow-sm">Our Standard</div>
                </div>
                <h3 className="text-xs font-black text-brand-blue uppercase tracking-[0.3em] mb-12">The Artist Mall Advantage</h3>
                <div className="space-y-8">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="flex-1">
               ...
               <p className="text-slate-500 text-lg leading-relaxed font-medium mb-10">
                 From corporate events to weddings and private functions, our process helps clients find suitable artists and coordinate event requirements.
               </p>
               <div className="grid grid-cols-2 gap-8">
                  <div className="space-y-2">
                    <p className="text-3xl font-black text-slate-900">₹150Cr+</p>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Bookings Supported</p>
                  </div>
                  <div className="space-y-2">
                    <p className="text-3xl font-black text-slate-900">4.9/5</p>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Client Rating</p>
                  </div>
               </div>
            </div>
      ...
      <section className="py-40 bg-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <h2 className="text-6xl font-black text-white mb-8 tracking-tighter">Use a Clear Booking Process.</h2>
...
const FeatureBox = ({ icon: Icon, title, description, color }: any) => {
  ...
  return (
    <div className="bg-white border border-slate-100 rounded-[40px] p-12 hover:shadow-2xl hover:-translate-y-2 transition-all shadow-sm group">
      <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-10 border transition-transform group-hover:scale-110 ${colorMap[color]}`}>
...
const ComparisonItem = ({ label, negative = false }: any) => (
  <div className="flex items-center gap-4">
    <div className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 ${negative ? 'bg-red-50 text-red-400' : 'bg-green-50 text-brand-success'}`}>
       {negative ? (
    ...
    <span className={`text-sm font-bold ${negative ? 'text-slate-400' : 'text-slate-900'} tracking-tight`}>{label}</span>
  </div>
);
