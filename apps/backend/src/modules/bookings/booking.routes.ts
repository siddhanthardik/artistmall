...
router.post('/:id/negotiate', requireRole('BOOKING_COMPANY', 'MANAGEMENT_COMPANY'), BookingController.negotiate);
...
router.post('/:id/complete', requireRole('SUPER_ADMIN', 'SUB_ADMIN', 'INTERNAL_OPS'), BookingController.completeBooking);
