        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h2 className="text-2xl font-black text-slate-900">
              Deal Room: {booking.artistId?.name || 'Artist'}
            </h2>
        ...
        <div className="text-right">
          ...
          <div className="flex items-center gap-2 justify-end">
            <span className="text-sm font-bold text-slate-900">
              {booking.artistId?.createdBy?.email || 'Agency'}
            </span>
          ...
          <div className="flex flex-col items-start max-w-2xl">
            <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm relative w-full">
              <div className="flex justify-between items-start mb-6">
                <span className="text-[10px] font-black text-[#1E4DB7] bg-blue-50 px-2 py-1 rounded uppercase tracking-widest">
                  Initial Inquiry
                </span>
              ...
              <div className="mb-6">
                ...
                <p className="text-3xl font-black text-slate-900">
                  ₹{booking.originalOffer?.toLocaleString()}
                </p>
              </div>
            ...
            <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-3 ml-4">
              Sent by You (Demand)
            </div>
          </div>
              ...
              <div className="max-w-2xl w-full">
                <div className="bg-white border-2 border-[#FF7A2F]/20 rounded-2xl p-6 shadow-md relative">
                  ...
                  <div className="mb-6 pl-2">
                    ...
                    <p className="text-3xl font-black text-slate-900">
                      ₹{booking.currentOffer?.toLocaleString()}
                    </p>
                  </div>
                ...
                <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-3 mr-4 text-right">
                  Received from Supply side
                </div>
              </div>
            </div>
          )}
        ...
        <div className="p-8 bg-white border-t border-slate-100">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex flex-wrap gap-4 items-end">
              ...
              >
                {mutation.isPending && mutation.variables?.action === 'COUNTER' ? (
