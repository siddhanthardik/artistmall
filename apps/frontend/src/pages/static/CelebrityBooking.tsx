      ...
      <section className="relative pt-48 pb-32 overflow-hidden bg-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
          <div className="max-w-4xl">
            ...
            >
              Send inquiries for celebrity appearances, live performances, and brand engagements
              through a structured booking process.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-24">
            ...
            <p className="text-slate-500 font-bold uppercase tracking-[0.25em] text-xs">
              Professional coordination for high-impact presence
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-24">
            <div className="flex-1">
              <div className="aspect-[4/5] rounded-[48px] bg-slate-900 overflow-hidden shadow-2xl relative border-8 border-white">
                ...
                <img
                  src="/images/celebrity_compliance.png"
