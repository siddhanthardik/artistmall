...
import { ChevronRight, Download, CheckCircle2, Play, MessageCircle } from 'lucide-react';
            ...
            <div className="lg:col-span-8 space-y-20">
              ...
              <div className="space-y-10">
                <div className="flex items-center gap-6">
                  ...
                  <h2 className="text-2xl font-bold text-neutral-content tracking-tight">
                    Biography
                  </h2>
                </div>
                      ...
                      >
                        <div className="relative aspect-video rounded-3xl overflow-hidden bg-neutral-content shadow-lg">
                          <img
                            ...
                            onError={(e: any) =>
                              (e.target.src = resolveMediaUrl(artist.profileImage))
                            }
                          />
              ...
              <div className="sticky top-32 space-y-8">
                ...
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[32px] shadow-2xl p-10 space-y-10 relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-neutral-content/30 mb-3">
                        Price Range
                      </p>
                      ...
                      <p className="text-xs font-medium text-neutral-content/40 mt-3 leading-relaxed">
                        Based on event type & venue requirements.
                      </p>
                    </div>

                    <div className="pt-8 mt-8 border-t border-neutral-content/10">
                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-neutral-content/30 mb-4">
                        Available For
                      </p>
                      <div className="flex flex-wrap gap-2">
                        {(artist.bookingTypes || ['Corporate Events', 'Weddings', 'Festivals']).map(
                          (type, i) => (
                            <span
                              key={i}
                              className="bg-neutral-content/5 text-neutral-content/60 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border border-neutral-content/5"
                            >
                              {type}
                            </span>
                          ),
