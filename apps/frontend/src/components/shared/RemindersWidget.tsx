...
const DUMMY_REMINDERS: Reminder[] = [
  {
    id: '1',
    priority: 'HIGH',
    message: 'Booking #8423 has been awaiting your counter-offer for > 48 hours.',
    actionText: 'Review Deal',
    actionLink: '/dashboard/booking/negotiations',
  },
  {
    id: '2',
    priority: 'MEDIUM',
    message: 'Advance payment deadline approaching for Neha Kakkar event.',
    actionText: 'Process Payment',
    actionLink: '/dashboard/booking/requests',
  },
];
          ...
          >
            <div className="flex-1 pr-4">
              ...
              {reminder.priority === 'HIGH' && (
                <span className="mt-2 inline-block text-[10px] font-bold text-red-400 bg-red-500/10 px-2 py-0.5 rounded border border-red-500/20">
                  URGENT
                </span>
              )}
            </div>
