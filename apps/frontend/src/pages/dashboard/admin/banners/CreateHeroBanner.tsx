    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-20">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <label className="text-[10px] font-black text-neutral-content/40 uppercase tracking-widest ml-1">Banner Image (16:9 Recommended)</label>
          <div 
            ...
            {formData.imageUrl ? (
              ...
              <>
                ...
                <div className="text-center px-6">
                  <p className="text-[10px] font-black text-neutral-content/40 uppercase tracking-widest">Click to upload banner</p>
                  <p className="text-[8px] font-bold text-neutral-content/20 uppercase mt-1">JPG, PNG up to 5MB</p>
                </div>
              </>
            )}
            <input 
          ...
          <div className="bg-white border border-surface-container rounded-[32px] p-8 space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-xs font-black text-neutral-content uppercase tracking-tight">Active Status</p>
              ...
              >
                <div className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform duration-300 ${formData.isActive ? 'translate-x-6' : ''}`}></div>
              </button>
            </div>
            
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-xs font-black text-neutral-content uppercase tracking-tight">Open in New Tab</p>
                <p className="text-[10px] font-bold text-neutral-content/40">For external CTA links</p>
              </div>
              <button 
                type="button"
              ...
              >
                <div className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform duration-300 ${formData.openInNewTab ? 'translate-x-6' : ''}`}></div>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white border border-surface-container rounded-[40px] p-10 space-y-8">
            <div className="grid grid-cols-1 gap-8">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-neutral-content/40 uppercase tracking-widest ml-1">Main Heading (Title)</label>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-neutral-content/40 uppercase tracking-widest ml-1">Subtitle / Description</label>
                <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-neutral-content/40 uppercase tracking-widest ml-1">CTA Button Text</label>
                  <div className="relative">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-neutral-content/40 uppercase tracking-widest ml-1">CTA Redirect Link</label>
                  <div className="relative">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-neutral-content/40 uppercase tracking-widest ml-1">Manual Display Order</label>
                <input 
                  type="number" 
                ...
                />
                <p className="text-[9px] font-bold text-neutral-content/30 uppercase tracking-tighter ml-1">Lower numbers appear first in the slider.</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              {saveMutation.isPending ? <Loader2 className="w-5 h-5 animate-spin" /> : <Check className="w-5 h-5 stroke-[3]" />}
